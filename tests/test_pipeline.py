...
class TestOCRPipeline:
    ...
    def mock_detector(self):
        ...
        mock_word = Mock()
        mock_word.polygon = [[10, 10], [110, 10], [110, 50], [10, 50]]  # Прямоугольник 100x40
        ...
        detector.infer.return_value = mock_page
        return detector
    ...
    def test_process_basic_page_output(self, pipeline, test_image):
        ...
        pipeline.detector.infer.assert_called_once()
    ...
    def test_process_no_text_detected(self, pipeline, test_image):
        ...
        pipeline.detector.infer.return_value = empty_page
    ...
    def test_process_small_text_regions_filtered(self, pipeline, test_image):
        ...
        pipeline.detector.infer.return_value = mock_page
